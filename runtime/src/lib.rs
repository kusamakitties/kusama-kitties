...
use rstd::prelude::*;
use sr_primitives::traits::{BlakeTwo256, Block as BlockT, ConvertInto, DigestFor, NumberFor, StaticLookup, Verify};
use sr_primitives::weights::Weight;
use sr_primitives::{
	create_runtime_str, generic, impl_opaque_keys, transaction_validity::TransactionValidity, AnySignature, ApplyResult,
};
#[cfg(feature = "std")]
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("kusama-kitties"),
	impl_name: create_runtime_str!("kusama-kitties"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
