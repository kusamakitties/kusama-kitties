...
use kusama_kitties_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	kusama_kitties_runtime::api::dispatch,
	kusama_kitties_runtime::native_version
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = substrate_service::ServiceBuilder::new_full::<
			kusama_kitties_runtime::opaque::Block,
			kusama_kitties_runtime::RuntimeApi,
		...
		.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
			...
			let (block_import, link_half) = grandpa::block_import::<_, _, _, kusama_kitties_runtime::RuntimeApi, _, _>(
				client.clone(),
				client.clone(),
				select_chain,
			)?;
